...
class UdongTest {
    ...
    private Participants initialParticipants;
    ...
    void setUp() {
        ...
        initialParticipants = Participants.from(1L);
    ...
    private Udong createUdong(Content content, Participants participants, RecruitPlanner recruitPlanner, TravelPlanner travelPlanner, AttachedTags attachedTags) {
    ...
    void 여행_시작일이_오늘일_경우_상태는_IN_PROGRESS로_설정된다() {
        ...
        Udong udong = createUdong(content, initialParticipants, recruitPlanner, todayTravel, attachedTags);
